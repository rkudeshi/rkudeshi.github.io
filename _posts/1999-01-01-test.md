...
All movies actually nominated are now in **bold**. In 8(!) categories, there were movies or people nominated that no one originally predicted - those are indicated below each category. Remember, this data was originally pulled a month before the nominations were announced - a lot can change in that time!
...
Not predicted, but surprisingly nominated: `Cold War (Pawel Pawlikowski)`.
...
Not predicted, but surprisingly nominated: `The Ballad of Buster Scruggs`.
...
Not predicted, but surprisingly nominated: `Never Look Away`.
...
Not predicted, but surprisingly nominated: `Bohemian Rhapsody`.
...
Not predicted, but surprisingly nominated: `Solo: A Star Wars Story` and `Christopher Robin`.
...
Not predicted, but surprisingly nominated: `Late Afternoon`.
...
Not predicted, but surprisingly nominated: `Lifeboat`.
