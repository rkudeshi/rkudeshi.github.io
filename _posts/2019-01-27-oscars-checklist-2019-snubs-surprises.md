...
Not predicted, but nominated: `Cold War (Pawel Pawlikowski)`.
...
Not predicted, but nominated: `The Ballad of Buster Scruggs`.
...
Not predicted, but nominated: `Never Look Away`.
...
Not predicted, but nominated: `Bohemian Rhapsody`.
...
Not predicted, but nominated: `Solo: A Star Wars Story` and `Christopher Robin`.
...
Not predicted, but nominated: `Late Afternoon`.
...
Not predicted, but nominated: `Lifeboat`.
