...
[^1]: The only movie I missed: the 8-hour OJ Simpson documentary. But you better believe I'm going to complete the Oscar Death Race this year!
...
Here's [Gold Derby's data](www.goldderby.com/odds/expert-odds/oscars-nominations-2018) for all 24 Oscar categories. I downloaded the data on 1/20 and calculated the "points" for each category using a simple implied probability conversion from fractional odds to decimal points.
...
* **Blade Runner 2049** (136.12 total points)
    ...
    - <small>25.00 pts (2nd) for Best Production Design *(3/1 odds)*</small>
...
* **Get Out** (77.11 total points)
    ...
    - <small>15.38 pts (3rd) for Best Film Editing *(11/2 odds)*</small>
...
* **Split** (0.99 total points)
    - <small>0.99 pts (8th) for Best Actor (James McAvoy) *(100/1 odds)*</small>
...
* **Three Billboards Outside Ebbing, Missouri** (124.98 total points)
    ...
    - <small>8.33 pts (5th) for Best Director (Martin McDonagh) *(11/1 odds)*</small>
...
|-----|--------------|-----------------------------------------------|------------|-------------|
| Num |    Points    |                     Movie                     | Categories |    Genre    |
|     |              |                                               | (Pts/Cat)  |             |
|-----|--------------|-----------------------------------------------|------------|-------------|
